...
![GitHub Repo stars](https://img.shields.io/github/stars/ZeroGamer01/VideoPlayerBot?color=blue&style=flat)
![GitHub forks](https://img.shields.io/github/forks/ZeroGamer01/VideoPlayerBot?color=green&style=flat)
![GitHub issues](https://img.shields.io/github/issues/ZeroGamer01/VideoPlayerBot)
![GitHub closed issues](https://img.shields.io/github/issues-closed/ZeroGamer01/VideoPlayerBot)
![GitHub pull requests](https://img.shields.io/github/issues-pr/ZeroGamer01/VideoPlayerBot)
![GitHub closed pull requests](https://img.shields.io/github/issues-pr-closed/ZeroGamer01/VideoPlayerBot)
![GitHub contributors](https://img.shields.io/github/contributors/ZeroGamer01/VideoPlayerBot?style=flat)
![GitHub repo size](https://img.shields.io/github/repo-size/ZeroGamer01/VideoPlayerBot?color=red)
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/ZeroGamer01/VideoPlayerBot)
![GitHub](https://img.shields.io/github/license/ZeroGamer01/VideoPlayerBot)
[![Bot Updates](https://img.shields.io/badge/VideoPlayerBot-Updates%20Channel-green)](https://t.me/ZeroGamer01)
[![Bot Support](https://img.shields.io/badge/VideoPlayerBot-Support%20Group-blue)](https://t.me/AwesomeSupport)

An Telegram Bot By [@ZeroGamer01](https://t.me/ZeroGamer01) To Stream Videos in Telegram Voice Chat.
...
4. `SESSION_STRING` : Pyrogram Session String of User Account, get it from [@genStr robot](http://t.me/genStr_robot) or [![genStr](https://img.shields.io/badge/repl.it-genStr-yellowgreen)](https://replit.com/@AsmSafone/genStr)
...
## Self Host
```sh
$ git clone -b main https://github.com/ZeroGamer01/VideoPlayerBot
$ cd VideoPlayerBot
...
Copyright (c) 2021  ZeroGamer01 <https://github.com/ZeroGamer01>
...
- [Me](https://github.com/ZeroGamer01) for [Noting](https://github.com/ZeroGamer01/VideoPlayerBot) 😬
- [Dan](https://github.com/delivrance) for [Pyrogram](https://github.com/pyrogram/pyrogram) ❤️
- [MarshalX](https://github.com/MarshalX) for [pytgcalls](https://github.com/MarshalX/tgcalls) ❤️
- And Thanks To All [Contributors](https://github.com/ZeroGamer01/VideoPlayerBot/graphs/contributors)! ❤️
